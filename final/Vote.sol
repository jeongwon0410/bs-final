// SPDX-License-Identifier: MIT pragma solidity >=0.4.22 <0.9.0; import "hardhat/console.sol";

contract BContract { struct Candidate { uint index; string nickName; string comment; string url; string imgUrl; uint point;
